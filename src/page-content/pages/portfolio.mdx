...
I store many of my personal projects and school assignments in GitHub repositories, so I decided to display them here using the GitHub <span style="color:#e535ab">GraphQL API <GrGraphQl/></span>
